...
function __init__()
    ...
    external_url = "https://unpkg.com/i2dgraph@0.0.2/i2dgraph/async-interactive_2d_graph.js",
    dynamic = nothing,
    async = :true,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/i2dgraph@0.0.2/i2dgraph/async-interactive_2d_graph.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
